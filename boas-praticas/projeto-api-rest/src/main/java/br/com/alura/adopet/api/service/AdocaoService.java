...
public class AdocaoService {
    ...
    public void solicitar(@RequestBody @Valid Adocao adocao) {
        ...
        emailService.enviarEmail(adocao.getPet().getAbrigo().getEmail(), "Solicitação de adoção", message);
    }

    public void aprovar(@RequestBody @Valid Adocao adocao) {
